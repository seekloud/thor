...
object Constants {
  ...
  val pictureMap = mutable.HashMap[String,String] (
    ...
    "food0-0.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/898027aecfe0ca4bc5efba1a8d86c801.png",
    "food0-1.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/694804e8125972d6d64cd4ddbf302d9f.png",
    "food0-2.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/d661228afb66f116c96467854e1003ca.png",
    "food0-3.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/b1198b84f1cace1fcfa103ec4aa27855.png",
    "food0-4.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/38d2abb409df3af9fbf44b0918b06468.png",
    "food0-5.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/d677ddb2ea2dbdfe544c86d5a50e184f.png",
    "food0-6.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/dbe4b2d13c69cd146b369ee4808caf97.png",
    "food0-7.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/d49496ba3b0b11b4d4364bdde831e931.png",
    "food2.png" -> "http://pic.neoap.com/hestia/files/image/OnlyForTest/08fcf5555e9456dcd45a4c8c3aabb8a9.png",
