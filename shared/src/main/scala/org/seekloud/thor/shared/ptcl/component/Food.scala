...
/**
  ...
  */
case class FoodState(fId: Int, level:Byte, position: Point, radius: Float, color: Byte, scatterStep: Option[Byte] = None)
...
case class AddNormalFood(
                        ...
                        var radius: Float,
                        var color: Byte,
                        var scatterStep: Option[Byte] = None
                        ) extends Food